...
An iLEAP CLI skill is defined at `.agents/skills/ileap/`. Read both files before working with iLEAP data:
...
2. `scripts/package-skill.sh` — produce `dist/ileap-skill.zip`, ready to upload at claude.ai (Settings → Capabilities → Skills) or to unpack into any agent's skills directory
